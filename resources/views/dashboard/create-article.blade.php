              ...
              <div class="card col-8">
                ...
                <div class="card-body">
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <input type="text" name="title" class="form-control" id="basic-default-fullname" placeholder="John Doe" required/>
                        ...
                        <button type="submit" class="btn btn-primary">Add Article <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2 13v-2h16.172l-3.95-3.95l1.414-1.414L22 12l-6.364 6.364l-1.414-1.414l3.95-3.95z"/></svg></button>
                    </form>
                </div>
              </div>
              <!-- Bootstrap Table with Header - Footer -->
