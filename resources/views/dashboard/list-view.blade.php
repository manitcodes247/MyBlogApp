...
<html
  ...
  <body>
              ...
              <div class="card">
                <div class="table-top-bar">
                  ...
                  <div class="table-right">
                    <a type="button" class="btn btn-primary" href="{{ route('articles.create') }}" >Add New Article
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"/></svg>
                  </a>
                  </div>
                </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="options-wrap">
                              <a class="options-btn options-btn3" href="{{ route('articles.show', $article) }}">
                                <i class="icon-base ri ri-eye-line icon-14px"></i>
                                View
                              </a>
                              <a class="options-btn options-btn1" href="{{ route('articles.edit', $article) }}">
                                <i class="icon-base ri ri-pencil-line icon-14px"></i>
                                Edit
                              </a>
                              <form action="{{ route('articles.destroy', $article) }}" method="POST" class="d-inline" 
                                ...
                                @csrf
                                @method('DELETE')
                                <button class="btn options-btn options-btn2" type="submit">
                                  <i class="icon-base ri ri-delete-bin-6-line icon-14px"></i>
                                  Delete
                                </button>
                              </form>
                            </div>
    ...
    <!-- Add Modal -->
    <div class="modal modal-top fade" id="modalAdd" tabindex="-1">
      <div class="modal-dialog">
        <form class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalTopTitle">Add New Article</h5>
            <button
              type="button"
              class="btn-close"
          ...
          <div class="modal-body">
            <div class="card-body">
              <form>
                ...
                <button type="submit" class="btn btn-primary">Send <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2 13v-2h16.172l-3.95-3.95l1.414-1.414L22 12l-6.364 6.364l-1.414-1.414l3.95-3.95z"/></svg></button>
              </form>
            </div>
          </div>
        </form>
    ...
    <!-- Edit Modal -->
    <div class="modal modal-top fade" id="modalEdit" tabindex="-1">
      <div class="modal-dialog">
        <form class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalTopTitle">Edit Article</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
          ...
          <div class="modal-body">
            <div class="card-body">
              <form>
                ...
                <button type="submit" class="btn btn-primary">Update <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m10 15.17l9.192-9.191l1.414 1.414L10 17.999l-6.364-6.364l1.414-1.414z"/></svg></button>
              </form>
            </div>
          </div>
        </form>
